...
export default function ModalForm(props) {
  ...
  return (
    <div className={styleClasses.join(' ')}>
      <Flash >
      <span role="emoji" aria-lavel="sademoji" style={{fontSize:"2vh"}}>정말로 탈퇴하시겠습니까?😥 {sessionUser.user_email}</span>
      </Flash>
      <br/>
      <button className="Button" onClick={(async () => {await dispatch(deleteRequest(sessionUser.user_email))})}>
        네! 
      </button>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
